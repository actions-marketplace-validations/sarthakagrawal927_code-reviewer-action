...
export async function stopAgent(
  ...
  return safeInvoke("stop_agent", { agentId });
}
...
export async function checkAccountUsage(accountId: string): Promise<AccountUsage> {
  return safeInvoke("check_account_usage", { accountId });
}
...
export async function listGitBranches(
  ...
  return safeInvoke("list_git_branches", { repoPath });
}
...
export async function getGitRemoteInfo(
  ...
  return safeInvoke("get_git_remote_info", { repoPath });
}
...
export async function reorderChatTabs(tabIds: string[]): Promise<void> {
  await safeInvoke("reorder_chat_tabs", { tabIds });
}
...
export async function importLinearIssues(issueIds: string[]): Promise<{ imported: number }> {
  return safeInvoke("import_linear_issues", { issueIds });
}
...
export async function openInApp(
  ...
  return safeInvoke("open_in_app", { appName, path });
}
...
export async function getPullRequest(
  ...
  return safeInvoke("get_pull_request", { repoPath, prNumber });
}
...
export async function mergePullRequest(
  ...
  return safeInvoke("merge_pull_request", { repoPath, prNumber, method });
}
...
export async function listCiChecks(
  ...
  return safeInvoke("list_ci_checks", { repoPath, prNumber });
}
...
export async function rerunFailedChecks(
  ...
  return safeInvoke("rerun_failed_checks", { repoPath, prNumber });
}
...
export async function spawnTerminal(
  ...
  return safeInvoke("spawn_terminal", { cwd, terminalId });
}
...
export async function writeTerminal(
  ...
  return safeInvoke("write_terminal", { terminalId, data });
}
...
export async function resizeTerminal(
  ...
  return safeInvoke("resize_terminal", { terminalId, cols, rows });
}

export async function closeTerminal(terminalId: string): Promise<void> {
  return safeInvoke("close_terminal", { terminalId });
}
...
export async function createReviewDoc(
  ...
  return safeInvoke("create_review_doc", { repoPath, branch });
}
...
export async function getReviewState(
  ...
  return safeInvoke("get_review_state", { reviewId, repoPath });
}
...
export async function claimFile(
  ...
  return safeInvoke("claim_file", { reviewId, repoPath, agentId, file });
}
...
export async function addCoordinatedFinding(
  ...
  await safeInvoke("add_finding", { reviewId, repoPath, finding });
}
